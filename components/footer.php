<footer class="footer">
   ...
   <section class="grid">
      ...
      <div class="box">
         ...
         <a href="mailto:shorifa825@gmail.com"><i class="fas fa-envelope"></i> shorifa825@gmail.com</a>
   ...
   <div class="credit">&copy; copyright @ <?= date('Y'); ?> by <span>mrs. web designer</span> | all rights reserved!</div>
